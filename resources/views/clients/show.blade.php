        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row"  id="CRImport">
                    ...
                    <button class="btn btn-secondary" id="CLetterbtn" type="button" data-toggle="modal" data-target="#ReImportSummary"></i>&nbsp;&nbsp;RE-IMPORT SUMMARY</button>
...
<div class="modal fade" id="ImportCreditReport" tabindex="-1" role="dialog" aria-labelledby="ImportCreditReport" aria-hidden="true">
    ...
    <div class="modal fade" id="ReImportSummary" tabindex="-1" role="dialog" aria-labelledby="ReImportSummary" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="row"> 
                        <div class="col" id="title"> 
                            <h5 class="modal-title"> RE-IMPORT SUMMARY</h5>
                        </div>
                ...
                <div class="modal-body">
                    <div class="ReImportSummary">
                        <div>
                            <img src="/img/5sdark.png" alt="" width="50px">
                            <h1>PROGRESS REPORT</h1>
                            <p>This report data was generated by 5 S Enteprises LLC and shows the progress since November 16, 2025</p>
                        </div>
                        <div class="SummaryDetails">
                            <h3>ASHLEY RUIZ</h3>
                            <h5>Mar 17, 2025</h5>
                            <h6>Five S Enterprises LLC</h6> 
                        
                        </div>
                        <div class="SummaryImg">
                               <img src="/img/preport.png" alt="Summary" width="700px">
                        </div>
                        <br>
                        <div class="ProgressReport">
                            <h4>PROGRESS REPORT FOR ASHLEY RUIZ</h4>
                            <h6>Created Summary: Apr 17, 2025 - Previous: Nov 16, 2025</h6>
                        </div>

                        <div class="CRMLogo">
                            <img src="/img/mfsn.png" alt="" width="220px">
                        </div>
                        <div class="NewScore">
                            <h4>YOUR NEW SCORE IS HERE!</h4>
                            <p>Note: It is not unusual for scores to go down during first few rounds of credit repair</p>
                        </div>
                        <div class="row" id="CScores">
                            <div class="col">
                               <img src="/img/equifax.png" alt="Equifax" width="120px">
                               <div id="equifax-modal" style="height: 200px; margin-top: 30px;"></div>
  
                              <h6>Prev Score: <span id="PrevScore">680</span></h6>
                        
                           
                            </div>
                            <div class="col">
                                <img src="/img/experian.png" alt="Equifax" width="120px">
                                
                               <div id="experian-modal" style="height: 200px; margin-top: 30px;"></div>
       
                                <h6>Prev Score: <span id="PrevScore">650</span></h6>
                            </div>
                            <div class="col">
                                <img src="/img/transunion.png" alt="Equifax" width="120px">
                                 <div id="transunion-modal" style="height: 200px; margin-top: 30px;"></div> 
                                 <h6>Prev Score: <span id="PrevScore">620</span></h6>
                            </div>
                        </div>
                        <div class ="ChangesReport">
                            <h6> Changes since you last Credit Report </h6>
                        </div>
                        <div class="row" id="CRUpdates">
                            ...
                            <!--end-->
                            <div class="CCUsage">
                                <h1> CREDIT CARD USAGE</h1>
                            </div>
                            <div class="row" id="CCUsagerow">
                                <div class="col-md-4" id="AvgUsage">
                                    <h3> Avg Usage</h3>
                                    <h1> 20 %</h1>
                                    <p>You have <b>$5,300.00</b> in revolving credit
                                        cards and your balances are <b>$1,046.00</b>
                                        which means that you are using avg.
                                        <b>20%</b> of your total available credit.</p>
                                </div>
                                <div class="col" id="AvgDetails">
                                    <div>
                                        <table width="100%">
                                            <tbody>
                                                <tr>
                                    ...
                                    <div class="row" id="PColors">
                                        ...
                                        <div class="col">
                                         <span class="verypoor"></span>
                                        </div>
                                    </div>
                                    <div class="row" id="PLabels">
                                        <div class="col">
                                            <h3> Excellent</h3>
                                        </div>
                                        <div class="col">
                        ...
                        <div class="BLogo">
                            <div class="row">
                                <div class="col" id="logo">
                                    <img src="/img/equifax.png" alt="" width="180px">
                                </div>
                                <div class="col-sm-5" id="improvement">
                                    <h3>Total Equifax Improvement:</h3>
                                </div>
            ...
            --></div> <!--col-->
                        ...
                        <div class="BLogo">
                            <div class="row">
                                <div class="col" id="logo">
                                    <img src="/img/experian.png" alt="" width="180px">
                                </div>
                                <div class="col-sm-5" id="improvement">
                                    <h3>Total Experian Improvement:</h3>
                                </div>
                                <div class="col-sm-2" id="Num">
                                    <h2> +50</h2>
                                    <h5>Since Nov 2024</h5>
...
">
    ...
    <div class="modal fade" id="ImportHTML" tabindex="-1" role="dialog" aria-labelledby="ImportHTML" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">    Paste HTML code here</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    ...
                    <div class="fields"> 
                        <div class="mb-3" id="importcsv">
                            <div class="row">
                                ...
                                <div class="col">
                                <textarea class="form-control" id="ImportHTML" rows="6"></textarea>
                                </div>
                            </div> 
                       
                          
                               <div class="HTMLDocuBtn">
                ...
                <div class="UDTable" style='overflow-x:auto'>
                    ...
                    <tbody>
                        <tr>
                           ...
                           <a href="#"class="btn">   <i class='bx bxs-trash'></i></a>
                            </td>
                        </tr>
                        <tr>
